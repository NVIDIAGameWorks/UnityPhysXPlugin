...
namespace NVIDIA.PhysX.UnityEditor
{
    ...
    public class PxD6JointEditor : PxJointEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_axes);
            ...
            EditorGUILayout.PropertyField(m_linearConstraints, new GUIContent("Linear Constraints"));
            ...
            EditorGUILayout.PropertyField(m_drive);
